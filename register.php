...
<head>
  <meta charset="UTF-8">
  <title>新規登録 - HUNG BOOK STORE</title>
  ...
  <main>
    <div class="auth-container">
      ...
      <form method="POST" action="register.php">
        ...
        <input type="email" name="email" placeholder="メールアドレス" required value="<?= htmlspecialchars($email ?? '') ?>">
        <input type="password" name="password" placeholder="パスワード" required>
        <button type="submit">登録</button>
      </form>
      <p style="margin-top: 15px;">アカウントをお持ちですか？ <a href="login.php" style="color: var(--secondary-color);">ログイン</a></p>
    </div>
  </main>
